...
function LightningBolt.new(Attachment0, Attachment1, PartCount)
	...
	self.MinThicknessMultiplier, self.MaxThicknessMultiplier = 0.1, 1 --Multiplies Thickness value by a fluctuating random value between MinThicknessMultiplier and MaxThicknessMultiplier along the Bolt
	...
	self.PulseSpeed = 5 --Bolt arrives at Attachment1 1/PulseSpeed seconds later. See https://www.desmos.com/calculator/hg5h4fpfim
	self.PulseLength = 1000000 --See https://www.desmos.com/calculator/hg5h4fpfim
	self.FadeLength = 0.1 --See https://www.desmos.com/calculator/hg5h4fpfim
